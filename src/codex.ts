...
export default class EditorJS {
  ...
  /**
   * Creating readonly state for rendered content by hiding all toolbar and focus
   */
  public disableEditableMode: () => void;
  ...
  public exportAPI(editor: Core): void {
    ...
    const disableEditableMode = () => {
      editor.moduleInstances.BlockManager.clearFocused();
      // editor.moduleInstances.BlockManager.clearSelection();
      editor.moduleInstances.Toolbar.hideBlockMenu();
      editor.moduleInstances.Listeners.removeAll();
    };

    this.disableEditableMode = disableEditableMode;
